...
after having found a .asd file? True by default.")
  ...
  (defun user-source-registry (&key (direction :input))
    (find-config-pathname "common-lisp" *source-registry-file* direction))
  (defun system-source-registry (&key (direction :input))
    (find-preferred-file (config-system-pathnames "common-lisp" *source-registry-file*)
                         :direction direction))
  (defun user-source-registry-directory (&key (direction :input))
    (find-config-pathname "common-lisp" *source-registry-directory* direction))
  (defun system-source-registry-directory (&key (direction :input))
    (find-preferred-file (config-system-pathnames "common-lisp" *source-registry-directory*)
                         :direction direction))
