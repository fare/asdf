...
and the order is by decreasing length of namestring of the source pathname.")
  ...
  (defun user-output-translations-pathname (&key (direction :input))
    (find-config-pathname "common-lisp" *output-translations-file* direction))
  (defun system-output-translations-pathname (&key (direction :input))
    (find-preferred-file (config-system-pathnames "common-lisp" *output-translations-file*)
                         :direction direction))
  (defun user-output-translations-directory-pathname (&key (direction :input))
    (find-config-pathname "common-lisp" *output-translations-directory* direction))
  (defun system-output-translations-directory-pathname (&key (direction :input))
    (find-preferred-file (config-system-pathnames "common-lisp" *output-translations-directory*)
                         :direction direction))
